...
class IconVSR(nn.Module):
    ...
    def __init__(self, 
        ...
        self.up2 = PSUpsample(num_feat, num_feat, scale_factor=2)
        self.up3 = PSUpsample(num_feat, 64, scale_factor=2)
        ...
        self.img_up = nn.Upsample(scale_factor=8, mode='bilinear', align_corners=False)
    ...
    def forward(self, lrs):
        ...
        for i in range(0, t):
            ...
            sr_rlt = self.lrelu(self.up3(sr_rlt))
            ...
            sr_rlt += base
            rlt[i] = sr_rlt
        return torch.stack(rlt, dim=1)[:, :, :, :8 * h_in, :8 * w_in]
